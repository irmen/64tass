...
Oper o_COMMAX      = { {&obj, 0}, "register indexing ',x", O_COMMAX, 3};
Oper o_COMMAY      = { {&obj, 0}, "register indexing ',y", O_COMMAY, 3};
Oper o_COMMAZ      = { {&obj, 0}, "register indexing ',z", O_COMMAZ, 3};
Oper o_COMMAS      = { {&obj, 0}, "register indexing ',s", O_COMMAS, 3};
Oper o_COMMAR      = { {&obj, 0}, "register indexing ',r", O_COMMAR, 3};
Oper o_COMMAD      = { {&obj, 0}, "register indexing ',d", O_COMMAD, 3};
Oper o_COMMAB      = { {&obj, 0}, "register indexing ',b", O_COMMAB, 3};
Oper o_COMMAK      = { {&obj, 0}, "register indexing ',k", O_COMMAK, 3};
