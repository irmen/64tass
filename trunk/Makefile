CC = gcc
OBJ = 64tass.o opcodes.o misc.o avl.o my_getopt.o eval.o error.o section.o encoding.o ternary.o
LANG = C
...
eval.o: eval.c eval.h misc.h libtree.h error.h section.h encoding.h
