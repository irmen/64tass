        ...
        if (labelname.len != 0) {
            ...
            case '=': 
                ...
                starassign:
                    ...
                    if (label != NULL) {
                        labelexists = true;
                        if (diagnostics.unused && !label->ref) err_msg_unused_symbol(label);
            ...
            }
            {
                ...
                if (labelexists) {
                    ...
                    if (!newlabel->update_after) {
                        ...
                        if (diagnostics.unused && !newlabel->ref) err_msg_unused_symbol(newlabel);
...
static int main2(int *argc2, char **argv2[]) {
    ...
    if (arguments.list == NULL) {
        ...
        if (diagnostics.unused) unused_check(root_namespace);
    }
